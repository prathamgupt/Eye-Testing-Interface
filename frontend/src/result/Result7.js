...
function Result7() {
  ...
  const handleSubmit = async (e) => {
    ...
    const newRes = {
      ...
      vision: "Vision: 6/9",
      spherical: "Approximate Spherical Refractive Error: 0.50",
      astigmatic: "Approximate Astigmatic Refractive Error: 1.00",
  ...
  const handleMail = () => {
    if (userMail) {
      ...
      const emailBody = `Dear ${currentUser},\n\nHere is your Eye Test Result:\n\nVision: 6/9\nApproximate Spherical Refractive Error: 0.50\nApproximate Astigmatic Refractive Error: 1.00\nYou have good vision\n\nThank you!`;
    ...
    <div className="App">
      {currentUser && (
        ...
        <h2>Here is your result: </h2>
          <h2>Vision: 6/9</h2>
          <h2>Approximate Spherical Refractive Error: 0.50</h2>
          <h2>Approximate Astigmatic Refractive Error: 1.00</h2>
          <h2>You have good vision</h2>
          {!saved && (
