...
function Result1() {
  ...
  const handleSubmit = async (e) => {
    ...
    const newRes = {
      ...
      vision: "Vision: less than 6/60",
      spherical: "Approximate Spherical Refractive Error: Greater than 3.00",
      astigmatic: "Approximate Astigmatic Refractive Error: Greater than 4.00",
  ...
  const handleMail = () => {
    if (userMail) {
      ...
      const emailBody = `Dear ${currentUser},\n\nHere is your Eye Test Result:\n\nVision: less than 6/60\nApproximate Spherical Refractive Error: Greater than 3.00\nApproximate Astigmatic Refractive Error: Greater than 4.00\nPlease Consult a doctor\n\nThank you!`;
    ...
    <div className="App">
      {currentUser && (
        ...
        <h2>Here is your result: </h2>
          <h2>Vision: less than 6/60</h2>
          <h2>Approximate Spherical Refractive Error: Greater than 3.00</h2>
          <h2>Approximate Astigmatic Refractive Error: Greater than 4.00</h2>
          <h2>Please Consult a doctor</h2>
          {!saved && (
