...
function Result3() {
  ...
  const handleSubmit = async (e) => {
    ...
    const newRes = {
      ...
      vision: "Vision: 6/36",
      spherical: "Approximate Spherical Refractive Error: 2.00",
      astigmatic: "Approximate Astigmatic Refractive Error: 4.00",
  ...
  const handleMail = () => {
    if (userMail) {
      ...
      const emailBody = `Dear ${currentUser},\n\nHere is your Eye Test Result:\n\nVision: 6/36\nApproximate Spherical Refractive Error: 2.00\nApproximate Astigmatic Refractive Error: 4.00\nPlease Consult a doctor\n\nThank you!`;
    ...
    <div className="App">
      {currentUser && (
        ...
        <h2>Here is your result: </h2>
          <h2>Vision: 6/36</h2>
          <h2>Approximate Spherical Refractive Error: 2.00</h2>
          <h2>Approximate Astigmatic Refractive Error: 4.00</h2>
