...
function Result2() {
  ...
  const handleSubmit = async (e) => {
    ...
    const newRes = {
      ...
      vision: "Vision: 6/60",
      spherical: "Approximate Spherical Refractive Error: Between 2.00 to 3.00",
    ...
    <div className="App">
      {currentUser && (
        ...
        <h2>Here is your result: </h2>
          <h2>Vision: 6/60</h2>
          <h2>Approximate Spherical Refractive Error: Between 2.00 to 3.00</h2>
