...
function Result4() {
  ...
  const handleSubmit = async (e) => {
    ...
    const newRes = {
      ...
      vision: "Vision: 6/24",
      spherical: "Approximate Spherical Refractive Error: 1.50",
      astigmatic: "Approximate Astigmatic Refractive Error: 3.00",
  ...
  const handleMail = () => {
    if (userMail) {
      ...
      const emailBody = `Dear ${currentUser},\n\nHere is your Eye Test Result:\n\nVision: 6/24\nApproximate Spherical Refractive Error: 1.50\nApproximate Astigmatic Refractive Error: 3.00\nPlease Consult a doctor\n\nThank you!`;
    ...
    <div className="App">
      {currentUser && (
        ...
        <h2>Here is your result: </h2>
          <h2>Vision: 6/24</h2>
          <h2>Approximate Spherical Refractive Error: 1.50</h2>
          <h2>Approximate Astigmatic Refractive Error: 3.00</h2>
